...
int main(int argc, char** argv) {
    ...
    readObj(path + "models/teapot.obj", triangles, m, getTransformMatrix(vec3(0, 0, 0), vec3(0, -0.5, 0), vec3(0.75, 0.75, 0.75)), true);
    ...
    float len = 13000.0;
    readObj(path + "models/quad.obj", triangles, m, getTransformMatrix(vec3(0, 0, 0), vec3(0, -0.5, 0), vec3(len, 0.01, len)), false);
    ...
    bool r = HDRLoader::load((path + "HDR/chinese_garden_2k.hdr").c_str(), hdrRes);
